            ...
            <form id="form1" runat="server">
                <div class="panel panel-primary">
                    ...
                    <div class="checkBlock">
                        ...
                        <asp:RadioButton CssClass="checkActive" GroupName="TipoTorneo" AutoPostBack="true" ID="radActivo" runat="server" Text="Torneos activos" OnCheckedChanged="OnCheckedState" />
                    </div>
