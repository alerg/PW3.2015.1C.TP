            ...
            <form id="formContact" runat="server" class="form-horizontal" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <asp:RequiredFieldValidator CssClass="alert-error" ID="RequiredFieldValidator1" EnableClientScript="true" runat="server" ErrorMessage="Campo Nombre Completo obligatorio" ControlToValidate="txtNombre" Display="Dynamic"></asp:RequiredFieldValidator>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <asp:RegularExpressionValidator CssClass="alert-error" Display="Dynamic" ID="RegularExpressionValidator1" EnableClientScript="true" 
                        ...
                        <asp:RequiredFieldValidator CssClass="alert-error" ID="RequiredFieldValidator2" EnableClientScript="true" 
                        ...
                        <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="Longitud máxima es de 30" 
                            onservervalidate="CustomValidatorEmail_ServerValidate" ControlToValidate="txtEmail" CssClass="alert-error" ClientValidationFunction="validarLongitudEmail"></asp:CustomValidator>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <asp:RequiredFieldValidator CssClass="alert-error" ID="RequiredFieldValidator3" EnableClientScript="true" runat="server" 
                        ...
                        <asp:CustomValidator ID="CustomValidator3" runat="server" ErrorMessage="Longitud máxima es de 200" 
                            onservervalidate="CustomValidatorMensaje_ServerValidate" ControlToValidate="txtAMensaje" CssClass="alert-error" ClientValidationFunction="validarLongitudMensaje" ></asp:CustomValidator>
                    </div>
                </div>
                <div class="form-group">
